...
class ProfesorForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        if queryset.exists():
            raise forms.ValidationError("Ya existe un profesor asociado al correo electrónico ingresado.")
    ...
    def clean_dni(self):
        ...
        if queryset.exists():
            raise forms.ValidationError(f"Ya existe un profesor asociado al DNI {dni}.")
